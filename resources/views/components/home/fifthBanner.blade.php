<div class="w-full h-[100vh] relative mt-[180px] flex justify-center items-center">
    <div style="background: linear-gradient(to top, transparent, rgb(3,6,8) 80%)"
        class=" absolute z-[5] top-0 left-0 w-full h-[400px]">
    </div>
    <div style="background: linear-gradient(transparent 0%, rgb(3,6,8) 90%)"
        class="absolute left-0 top-[71%] z-[1] w-full h-[300px]"></div>
    <div
        class="background_mode_game  absolute inset-0 bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/bltc28d43095579c8b5/5d87c24e8d8a3163705e3070/summonersrift.jpg)] bg-no-repeat bg-cover">
    </div>
    <div style="opacity: 0"
        class="background_mode_game  absolute inset-0 bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blt13186c22cf0a2f30/5d87c24e3166f22df2ab8dc4/howlingabyss.jpg)] bg-no-repeat bg-cover">
    </div>
    <div style="opacity: 0"
        class="background_mode_game  absolute inset-0 bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/bltf930a7a2b83fff60/5e17887df980a27e5b76ac2f/teamfighttactics.jpg)] bg-no-repeat bg-cover">
    </div>
    <div class="w-[90%] h-[90%] relative flex justify-center items-center z-[10]">
        <div
            class="absolute top-[50%] left-0 h-[50%] w-full border-[1px] border-[#888] flex justify-between items-center">
            <div class="w-[33%] flex flex-col justify-center items-center text-white">
                <h3 class="font-bold uppercase text-[20px] italic">Rất nhiều cách</h3>
                <h1 class="font-bold uppercase text-[60px] italic leading-[50px]">Chơi</h1>
                <button
                    class="uppercase  mt-[40px] text-[11px] hover:opacity-[.8] text-white py-3 w-[230px] bg-[rgb(19,216,246)] font-bold ">Chơi
                    ngay</button>
            </div>
            <div class="mt-[250px] w-[33%]">
                <div class="text-white text-center">
                    <h1 class="uppercase font-bold">CHẾ ĐỘ CHƠI PHỔ BIẾN NHẤT</h1>
                    <p class="text-[15px] mt-[10px]">Dọn đường, tham gia giao tranh tổng, phá hủy Nhà Chính của địch
                        trước khi Nhà Chính của bạn bị phá hủy.</p>
                </div>
            </div>
            <div class="w-[33%] flex flex-col items-end gap-[10px]">
                <div
                    class="w-[70%] h-[120px] relative text-white active_box_map hover:opacity-[.7] btn_mode_game transition-custom ">
                    <div class=" absolute top-[50%] left-0 translate-y-[-50%] w-full h-[50%] flex items-center
                    box_middle_map">
                        <div class="pr-[20px] text-[14px] w-[50%] font-medium uppercase text-right">SUMMONER'S RIFT
                            <div class="w-[50%]"></div>
                        </div>
                    </div>
                    <div class="absolute h-full w-[50%] left-[50%] top-[50%] translate-y-[-50%] flex items-center">
                        <div
                            class="w-[90px] h-[90px]  bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blt09b786139c8ce289/5d87c2420ca4b562bfff0abe/summonersrift.jpg)] bg-no-repeat bg-cover border-[1px] border-[rgb(11,198,227)] map_active_image">
                        </div>
                    </div>
                </div>

                <div class="w-[70%] h-[120px] relative text-white hover:opacity-[.7] btn_mode_game transition-custom">
                    <div
                        class="absolute top-[50%] left-0 translate-y-[-50%] w-full h-[50%] flex items-center box_middle_map">
                        <div class="pr-[20px] text-[14px] w-[50%] font-medium uppercase text-right">ARAM</div>
                        <div class="w-[50%]"></div>
                    </div>
                    <div class="absolute h-full w-[50%] left-[50%] top-[50%] translate-y-[-50%] flex items-center">
                        <div
                            class="w-[90px] h-[90px] bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blta1f5513b0207fc88/5d87c2428dbc4162c496928b/howlingabyss.jpg)] bg-no-repeat bg-cover border-[1px] border-[rgb(11,198,227)] map_active_image">
                        </div>
                    </div>
                </div>
                <div class="w-[70%] h-[120px] relative text-white hover:opacity-[.7] btn_mode_game transition-custom">
                    <div class=" absolute top-[50%] left-0 translate-y-[-50%] w-full h-[50%] flex items-center
                box_middle_map">
                        <div class="pr-[20px] text-[14px] w-[50%] font-medium uppercase text-right">Đấu trường chân lý
                            <div class="w-[50%]"></div>
                        </div>
                    </div>
                    <div class="absolute h-full w-[50%] left-[50%] top-[50%] translate-y-[-50%] flex items-center">
                        <div
                            class="w-[90px] h-[90px] bg-[url(https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/blt7bb04c5fde905d4b/5e17889f9bcbce578d63ee51/teamfighttactics.jpg)] bg-no-repeat bg-cover border-[1px] border-[rgb(11,198,227)] map_active_image">
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="w-[30vw] h-[30vw] rounded-full relative flex flex-col items-center justify-center">
            ...
            <div class="w-[28vw] h-[28vw] cycle_border rounded-full relative overflow-hidden">
                <video class="absolute w-full h-full video_mode_game transition-custom" loop autoplay="true"
                    muted="true">
                    <source
                ...
                <video style="opacity: 0" class="absolute w-full h-full video_mode_game transition-custom" loop
...
<script>
    const btn_mode_games = document.querySelectorAll('.btn_mode_game')
    const video_mode_games = document.querySelectorAll('.video_mode_game')
    const background_mode_games = document.querySelectorAll('.background_mode_game')

    let current_mode = 0;

    setInterval(() => {
        show_mode_game(current_mode)
    }, 4000);

    btn_mode_games.forEach((item, index) => {
        item.addEventListener('click', () => {
            show_mode_game(index)
        })
    })

    function show_mode_game (index) {
         current_mode++
        if (index >= btn_mode_games.length) {
            index = 0
            current_mode = 0;
        }

        btn_mode_games.forEach(item => {
            item.classList.remove('active_box_map')
        })

        btn_mode_games[index].classList.add('active_box_map')

        video_mode_games.forEach(item => {
            item.style.opacity = 0
        })

        video_mode_games[index].style.opacity = 1

        background_mode_games.forEach(item => {
            item.style.opacity = 0
        })

        background_mode_games[index].style.opacity = 1
    }
